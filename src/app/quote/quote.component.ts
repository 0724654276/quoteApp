...
export class QuoteComponent implements OnInit {
  ...
  quote: Quote[] = [
    new Quote( import { Component, OnInit } from '@angular/core';
    import { Quote } from "../quote";
    @Component({
      selector: 'app-quote',
      templateUrl: './quote.component.html',
    ...
    new Quote("The stars are for only those who can reach them', 'Nelson Mandela', 'Andy Taylor',  22, 11, new Date(2020, 10,4)),
    new Quote("The advance of technology is based on making it fit in so that you don't really even notice it, so it's part of everyday life`, 'Bill Gates', 'Andy Taylor",  13, 5, new Date(2021, 5, 7)),
    new Quote("Let's go invent tomorrow instead of worrying about what happened yesterday`, 'Steve Jobs', 'Andy Taylor", 40, 20, new Date(2021, 20, 8)),
    new Quote( "Freedom Of Mind", "Stephen Hawking", "Although i cannot move and i have to speak through a computer, in my mind i am free", "David",  60, 2, new Date(2018, 5,7))
